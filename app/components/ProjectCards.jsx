...
const ProjectCards = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <div className="group">
      ...
      >
        <div className="overlay flex items-center justify-center absolute top-0 left-0 w-full h-full bg-black bg-opacity-0 group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          <Link
            href={gitUrl}
      ...
      <div className="text-white rounded-b-x mt-3 bg-black py-6 px-4">
